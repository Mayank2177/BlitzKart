      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-primary-foreground/60 text-lg mb-8 max-w-lg font-body">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" className="font-heading font-bold text-base border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10">
                Browse Categories
              </Button>
            </div>
          </motion.div>
