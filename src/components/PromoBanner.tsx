    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-brand-dark rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-foreground/60 font-body">
              Use code <span className="font-bold text-primary">BLITZ100</span> at checkout. Min order ₹299.
            </p>
          </div>
          <Button size="lg" className="font-heading font-bold text-base gap-2 relative z-10 flex-shrink-0">
