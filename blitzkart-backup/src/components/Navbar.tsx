      ...
      <div className="container flex items-center gap-4 h-16">
        ...
        <div className="flex items-center gap-1">
          <Link to="/admin/inventory">
            <Button variant="ghost" size="icon" className="text-primary-foreground hover:text-brand-lime hover:bg-brand-charcoal" title="Inventory">
              <Package className="w-5 h-5" />
            </Button>
          </Link>
          <Link to="/admin/dispatch">
            <Button variant="ghost" size="icon" className="text-primary-foreground hover:text-brand-lime hover:bg-brand-charcoal" title="Dispatch">
