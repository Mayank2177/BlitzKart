...
import { Eye, EyeOff, Zap, ShoppingCart, Package, Truck } from "lucide-react";
...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({ title: view === "login" ? "Welcome back! ⚡" : "Account created! 🎉", description: "Redirecting to BlitzKart..." });
  };
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-dark relative overflow-hidden items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-primary-foreground/60 text-lg font-body mb-10">
          ...
          <div className="space-y-5">
            {[
              ...
              >
                ...
                <div>
                  <p className="text-primary-foreground font-medium font-body">{item.label}</p>
                  <p className="text-primary-foreground/40 text-sm font-body">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <Card className={`border border-border shadow-xl ${shaking ? "animate-shake" : ""}`}>
            <CardContent className="p-8">
              ...
              <p className="mb-6 text-sm text-muted-foreground font-body">
                {view === "login" && "Sign in to your BlitzKart account"}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {view === "login" && (
                        <button
                          ...
                          className="text-xs font-medium text-primary hover:underline font-body"
                        >
                          Forgot Password?
                        </button>
                      )}
              ...
              {view !== "forgot" && (
                <>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="h-11 w-full gap-3 font-body font-medium"
                    onClick={() => toast({ title: "Google Sign-In", description: "This is a UI demo." })}
                  >
